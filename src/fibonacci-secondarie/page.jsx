...
export const metadata = {
  title: "Giochi di Fibonacci - Scuole Secondarie",
  description: "Raccolta delle prove dei Giochi di Fibonacci per le scuole secondarie",
};
      ...
      <div className="mx-auto flex w-full max-w-screen-xl grow flex-col p-4 pb-8">
        <div className="flex flex-col gap-4">
          <h1 className="px-2 text-center text-2xl font-bold">
            Giochi di Fibonacci - Scuole secondarie
          </h1>
