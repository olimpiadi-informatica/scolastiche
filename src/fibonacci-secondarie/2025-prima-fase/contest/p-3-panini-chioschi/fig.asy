...
for (int i=0; i<panini; ++i)
    add(shift(-0.7, heights[0]/yfactor+i*0.55)*panino.drawing(0.025, bread = pcol[i%7]));
add(shift(-4, heights[0]/yfactor+0.5)*reflect((2, 1), (2, 0))*bunny.drawing(0.4, bunny.bunny_col));
