...
export default function Visualizer({ variables }) {
  ...
  if (hiddenState.N < 10000) {
    num = <Rectangle color="transparent" border_color="transparent" height={0.4} width={2.2} x={4.3} y={1.4} rotation={0.025} children={<span style={{fontFamily: "Orbitron"}}>{hiddenState.N}</span>} />
  }
