...
Non solo: alcune delle luci della fattoria potrebbero essere spente. Questo è un problema perché Allie ha paura del buio,
quindi non è disposta ad entrare in una stanza se prima non ne accende la luce. In ogni stanza ci sono due interruttori,
...
Allie parte di nuovo dal prato e deve andare a prendere tutti i coniglietti. Hai a disposizione questi blocchi:
...
Aiuta Allie a raccogliere tutti i coniglietti (senza stare al buio) prima di cominciare la ricreazione!
