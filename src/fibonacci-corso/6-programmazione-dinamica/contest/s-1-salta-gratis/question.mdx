...
Carol può atterrare o avanzare sulle rocce a pagamento, ma se lo fa dovrà pagare alcune carote di
penalità alla fine della corsa! Per non pagare il costo di una roccia marrone, l'unico modo è saltarla.
...
**non ci siano mai due rocce a pagamento di seguito**. Hai a disposizione questi blocchi per ispezionare la situazione:
...
Inoltre, hai a disposizione questi blocchi per fare la corsa:
