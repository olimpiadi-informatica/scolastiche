...
import customBlocks from "./s6.blocks";
...
Dovrai sfruttare le informazioni che puoi scrivere sulle pedane: sia la _preferenza_ numerica che la _direzione_. Puoi scegliere tu cosa
scriverci, e quindi come usare queste informazioni per decidere se fare salti in alto (verso la prossima pedana alta)
o in basso (verso la prossima pedana bassa).
