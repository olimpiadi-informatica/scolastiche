...
export default [
  ...
  },
  {
    ...
    fn: (ctx: Context, state: State, v1: number, v2: number) => {
      if (state.H !== v1) ctx.exit(false, "hai sbagliato a riportare l'altezza");
      if (state.W !== v2) ctx.exit(false, "hai sbagliato a riportare la larghezza");
      ctx.exit(true, "hai calcolato bene altezza e larghezza della torre, bravo!");
    },
  },
