...
import customBlocks from "./s0.blocks.yaml";
...
Se si atterra con un salto su una roccia alta si cade, perdendo la gara. Se invece si prova ad avanzare, non ci si riesce, restando fermi.
...
tasti blu _"Esegui/pausa"_, _"Esegui un blocco"_, _"Esegui da capo"_.

Se ti senti in difficoltà, prova anche a leggere questo suggerimento:

<Hint>
  Guarda dove si trova il coniglio: con che operazione devi iniziare?
  Ti serve avanzare o saltare? Una volta capito con quale delle due operazioni
  vuoi iniziare, cercala nella sezione _"Esecuzione"_ e trascinala sotto al blocco _"Inizia qui"_.
  Guarda dove arriva in questo modo il coniglio (puoi eseguire la tua soluzione!),
  e continua così per capire quali altre azioni devi fare dopo.
</Hint>
...
Prima di passare alla prossima domanda, assicurati di aver risolto questa!

Se l'hai risolta, dovresti vedere una _"V"_ verde in alto a sinistra, sopra la rappresentazione del livello, dopo la scritta **Livello**.