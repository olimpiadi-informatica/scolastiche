...
- `N`: il numero di rocce che all'inizio ti separano dalla bandierina **(nuovo!)**.
...
<Hint>
  Per poter risolvere tutti i livelli, dovrai fare un ciclo.

  Quale operazione devi mettere dentro al ciclo?

  Quante volte devi ripeterla?
</Hint>
