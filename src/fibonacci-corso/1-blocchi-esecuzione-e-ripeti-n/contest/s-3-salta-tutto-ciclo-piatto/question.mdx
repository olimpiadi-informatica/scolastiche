...
Puoi notare che il nuovo blocco `N` ha una forma stondata, diversa dagli altri: questo perché non è un'istruzione (un blocco che _fa qualcosa_), ma un blocco che _produce un valore_
...
che contengano un spazio di simile forma stondata.
...
Questo blocco ti consente di specificare quante volte vuoi ripetere alcune operazioni, mettendo un blocco stondato che vuoi al posto del numero standard di ripetizioni (10).
Puoi anche indicare quali sono le operazioni vuoi ripetere, mettendole nello spazio rettangolare che sta in mezzo al blocco.
