...
- `N`: il numero di rocce all'inizio che ti separano dalla bandierina.
- `M`: il numero di ostacoli che all'inizio ti separano dalla bandierina **(nuovo!)**.
...
<Hint>
  Guarda bene tutti i livelli. Quante volte devi saltare?

  Prima di ogni salto, quante volte al minimo devi avanzare per assicurarti di arrivare all'ostacolo?

  Dopo tutti i salti, quante volte al minimo devi avanzare per arrivare alla bandierina?
</Hint>
