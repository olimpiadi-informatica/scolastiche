import { M5PallineTricolori, M6StringaOii, M9HardRettangoliCornice, M12CavalieriFurfanti, M17QuasiOrdinato } from "problemset";
import { P8SostituisciRiga, P7TerzoNumero, P2SommaZero, P6WalkBack, P3StepInvariante, P4IntervalliNascosti,  P5PiuStampato } from "problemset";
...
<Section>
  ...
  <Problem points={[0, 0, 0]} statement={P6WalkBack} />
