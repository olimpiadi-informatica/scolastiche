...
`]}),`
`,e.jsx(n.p,{children:"Quindi ogni domanda a blocchi può valere fino a 15 punti in totale."})]})}function G(i={}){const{wrapper:n}={...f(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(u,{...i})}):u(i)}const I={title:"Giochi di Fibonacci",description:"Seconda fase dei Giochi di Fibonacci 2023/2024 per le scuole secondarie"};function _(){return e.jsxs(g,{contestName:"Giochi di Fibonacci",duration:100,children:[e.jsx(G,{}),e.jsx($,{})]})}export{_ as default,I as metadata};
//# sourceMappingURL=c67c50c4-page.js.map
